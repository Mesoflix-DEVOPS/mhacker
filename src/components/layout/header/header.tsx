...
const NotificationIcon = () => {
    ...
    return (
        <>
            ...
            >
                {/* Bell Icon SVG with notification badge */}
                <div className="notification-icon__container">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                        <path d="M12 22C13.1 22 14 21.1 14 20H10C10 21.1 10.9 22 12 22ZM18 16V11C18 7.93 16.36 5.36 13.5 4.68V4C13.5 3.17 12.83 2.5 12 2.5S10.5 3.17 10.5 4V4.68C7.63 5.36 6 7.92 6 11V16L4 18V19H20V18L18 16Z" fill="var(--text-prominent)"/>
                    </svg>
                        ...
                        <div className="notification-modal__header">
                            ...
                            >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z" fill="var(--text-prominent)"/>
                                </svg>
                            </button>
                        </div>
