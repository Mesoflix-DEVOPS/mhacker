...
const NotificationBellIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path
            d="M12 2C8.686 2 6 4.686 6 8V10.58C6 12.17 5.36 13.69 4.24 14.82L3.29 15.77C2.92 16.14 3.18 16.75 3.7 16.75H20.3C20.82 16.75 21.08 16.14 20.71 15.77L19.76 14.82C18.64 13.69 18 12.17 18 10.[...]
            fill="currentColor"
        />
    </svg>
);
